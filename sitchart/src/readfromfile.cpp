...
{
	FILE *rd[4];
	rd[0]=fopen("/home/pi/wd/sitchart/src/col_0","rb");
	rd[1]=fopen("/home/pi/wd/sitchart/src/col_1","rb");
	rd[2]=fopen("/home/pi/wd/sitchart/src/col_2","rb");
	rd[3]=fopen("/home/pi/wd/sitchart/src/col_3","rb");
	list *p=createlist();
	for(int i=0;i<4;i++)
		readone(rd[i],p);
	return p;
